...
const slideCount = 7; // Total de slides
const autoPlayDuration = 4000; // 5 segundos para autoplay
...
function resetProgressBar() {
    ...
    void progressBar.offsetWidth; // Forçar reflow
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Fate Series Carousel initialized successfully!');
});
